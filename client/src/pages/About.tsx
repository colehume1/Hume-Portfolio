        ...
        <div className="grid gap-12">
          ...
          >
            ...
            <div className="space-y-6 text-sm text-muted-foreground leading-[1.65]">
              ...
              <p>I kicked off my career as a consultant at Boston Consulting Group (BCG), where I got a crash course business education, working long hours on diverse problems with some of the smartest people (who probably could've been curing cancer rather than building slide decks)...but they were beautiful slide decks. My northstar was to become the technical-savvy business guy to the engineers changing the world. I now get to be that operator and work alongside some of the sharpest engineers in the world at Nominal, a generational company changing the hardware landscape and accelerating innovation. 

              In 2022, as optimism and concerns around AI became more relevant than ever, I helped re-found the AI Robotics Ethics Society (AIRES) at UCLA, and have maintained a passion for working near AI and helping the possible, optimistic outcomes be realized. </p>
