        ...
        <div className="grid gap-12">
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              >
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent"></div>
                  <p className="relative text-white text-sm leading-tight p-4 font-medium">I run at grandpa pace but love movement, the outdoors, and testing the limits of my silly asthma</p>
                </motion.div>
                {visibleCaption === 1 && (
                  <div className="absolute inset-0 sm:hidden flex items-end justify-start rounded-lg">
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent"></div>
          ...
          >
            ...
            <div className="space-y-6 text-sm text-muted-foreground leading-[1.65]">
              ...
              <p>I kicked off my career as a consultant at Boston Consulting Group (BCG), where I got a crash course business education, working long hours on diverse problems with some of the smartest people who probably should've been curing cancer rather than building slide decks...albeit, beautiful slide decks. My northstar was to become the technical-savvy business guy to the engineers changing the world. I now get to be that operator and work alongside some of the sharpest engineers in the world at Nominal, a generational company changing the hardware landscape and allowing for record-breaking innovation. In 2022, as optimism and concerns around AI became more relevant than ever, I helped re-found the AI Robotics Ethics Society (AIRES) at UCLA, and have maintained a passion for working near AI and helping the possible, incredible outcomes be realized. I am an avid investor of the coins I collect along the way and enjoy optimizing my portfolio. </p>
              <p>Put simply, I am a generalist, an engineer's business guy, a first principles and systems thinker, and drawn to work that rewards initiative, a dose of EQ, and intellectual curiosity.</p>
            </div>
          </motion.section>
