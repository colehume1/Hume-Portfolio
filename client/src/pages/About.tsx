        ...
        <div className="grid gap-12">
          ...
          >
            ...
            <div className="space-y-6 text-sm text-muted-foreground leading-[1.65]">
              ...
              <p>I kicked off my career as a consultant at Boston Consulting Group (BCG), where I got a crash course business education. My northstar is to become the technical-savvy business guy who empowers his teammates as a servant leader. I now get to exercise the operator skillset and work alongside some of the sharpest engineers in the world at Nominal, a generational company changing the hardware landscape and accelerating innovation. 
